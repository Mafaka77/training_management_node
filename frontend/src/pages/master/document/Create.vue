      ...
      <section
        ...
        <div class="grid grid-cols-1 gap-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <BaseInput v-model="form.title" label="Document Title" placeholder="e.g. Training Manual 2024"
              type="text" />
            <BaseInput v-model="form.description" label="Short Description"
              placeholder="Brief overview of the document content" type="text" />
          </div>
          ...
          <div class="space-y-2">
            ...
            <div
              class="p-1 bg-zinc-50 dark:bg-white/[0.02] rounded-xl border-2 border-dashed border-zinc-200 dark:border-white/10">
