<template>
  <div class="space-y-4">
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
      ...
      <router-link to="/admin/master/category/create"
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <div v-for="cat in categories" :key="cat._id" class="group relative flex items-center gap-4 p-4 rounded-2xl border transition-all duration-300
        ...
        <div class="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
          <router-link :to="{ name: 'master.category.edit', params: { id: cat._id } }"
