    ...
    <form @submit.prevent="submitForm">
      <section
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <BaseInput v-model="form.room_name" label="Room Name" placeholder="e.g. Executive Seminar Hall" type="text" />
          <BaseInput v-model="form.capacity" label="Seating Capacity" placeholder="e.g. 50" type="number" />

          <div class="md:col-span-2">
            <BaseInput v-model="form.details" label="Room Description & Amenities"
              placeholder="e.g. Projector available, high-speed Wi-Fi, localized AC control..." type="text" />
          </div>
        </div>
