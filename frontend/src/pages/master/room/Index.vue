<template>
  <div class="space-y-4">
    <div class="flex items-center justify-between mb-6">
      ...
      <router-link to="/admin/master/room/create"
    ...
    <div v-else class="grid grid-cols-1 gap-4">
      <div v-for="room in rooms" :key="room._id" class="group relative flex flex-col md:flex-row md:items-center gap-5 p-5 rounded-2xl border transition-all duration-300
        ...
        <div class="flex items-center gap-2 pt-4 md:pt-0 border-t md:border-t-0 border-zinc-100 dark:border-white/5">
          ...
          <button @click="openDeleteModal(room)" title="Delete Room" class="flex-1 md:flex-none p-2.5 rounded-xl transition-colors
