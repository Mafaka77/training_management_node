    ...
    <div class="space-y-4">
        ...
        <div v-else-if="locations.length === 0"
            ...
            <div class="p-4 rounded-full bg-zinc-100 dark:bg-white/5 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-zinc-400" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
                        d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
            </div>
            <h3 class="text-zinc-900 dark:text-zinc-100 font-medium">No locations available</h3>
            <p class="text-zinc-500 dark:text-zinc-400 text-sm mt-1">Get started by creating your first location.
            </p>
        </div>

        <div v-else class="grid grid-cols-1 gap-4">
            <div v-for="location in locations" :key="location._id" class="group relative flex flex-col md:flex-row md:items-center gap-5 p-5 rounded-2xl border transition-all duration-300
               ...
               hover:border-blue-500/50 dark:hover:border-blue-500/50">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <div class="flex items-center gap-1.5 text-xs font-medium text-zinc-500 dark:text-zinc-400">
                            ...
                            <span>{{ location.location.coordinates[1] }}, {{ location.location.coordinates[0] }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div
                    ...
                    <button @click="openDeleteModal(location)" title="Delete Location" class="flex-1 md:flex-none p-2.5 rounded-xl transition-colors
