<template>
  <div class="space-y-4">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div v-for="banner in banners" :key="banner._id" class="group relative flex flex-col overflow-hidden rounded-2xl border transition-all duration-300
        ...
        <div class="relative h-44 w-full overflow-hidden bg-zinc-100 dark:bg-zinc-800">
          <img :src="`${BASE_URL}${banner.image_url}`" :alt="banner.title"
        ...
        <div class="p-4 flex items-center justify-between">
          ...
          <div
            class="flex gap-1 opacity-0 group-hover:opacity-100 transition-all transform translate-x-2 group-hover:translate-x-0">
            ...
            <button @click="openDeleteModal(banner)"
  ...
  <BaseModal :show="isCreateModalOpen" @close="closeCreateModal" @confirm="handleSaveBanner" confirmText="Save Banner">
