  ...
  <div class="max-w-5xl mx-auto pb-12">
    ...
    <form @submit.prevent="submitForm" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="md:col-span-2 space-y-4">
            ...
            <BaseInput v-model="form.t_description" label="Program Overview"
              placeholder="Describe the objectives and outcomes..." type="textarea" rows="4" />
          </div>
      ...
      <div class="flex items-center justify-end gap-4 pt-4">
        ...
        <button type="submit"
          class="px-8 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold shadow-lg shadow-blue-500/30 transition-all active:scale-95">
      ...
      <div v-if="showStatusModal"
        ...
        <div
          ...
          <div class="p-6 text-center">
            <div
              class="mx-auto w-16 h-16 rounded-full bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center text-blue-600 mb-4">
            ...
            <p class="text-sm text-zinc-500 dark:text-zinc-400 px-4">
              Are you sure you want to mark this training as <span class="font-bold text-blue-600">Upcoming</span>? This
              will be available to public.
            </p>
          </div>

          <div
            class="flex items-center gap-3 p-6 bg-zinc-50 dark:bg-white/[0.02] border-t border-zinc-100 dark:border-white/5">
