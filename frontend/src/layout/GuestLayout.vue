  ...
  <div class="min-h-screen text-zinc-50 flex flex-col font-sans bg-zinc-950">
    <header class="sticky top-0 z-50 border-b border-white/10 bg-zinc-950/80 backdrop-blur-md">
      <div class="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
        ...
        <nav
          class="hidden md:flex items-center gap-2 p-3 bg-white/[0.03] border border-white/[0.08] rounded-full backdrop-blur-md">
    ...
    <Teleport to="body">
      <Transition enter-active-class="transition duration-300 ease-out" enter-from-class="opacity-0"
        ...
        <div v-if="isDrawerOpen" class="fixed inset-0 z-[100] bg-zinc-950/60 backdrop-blur-sm"
      ...
      <Transition enter-active-class="transition duration-500 ease-in-out transform" enter-from-class="translate-x-full"
        ...
        <div v-if="isDrawerOpen"
          class="fixed inset-y-0 right-0 z-[101] w-full max-w-xs bg-zinc-900 border-l border-white/10 shadow-2xl p-8 flex flex-col">
    ...
    <footer class="border-t border-white/10 bg-zinc-950 px-6 py-12">
      <div class="mx-auto max-w-7xl">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul class="space-y-3 text-[13px] text-zinc-500 font-light">
              ...
              <li><router-link to="/terms" class="hover:text-blue-500 transition-colors">Terms & Policy
                </router-link>
              </li>
            </ul>
          </div>
        ...
        <div
          class="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between gap-4 text-[11px] text-zinc-600 font-light">
