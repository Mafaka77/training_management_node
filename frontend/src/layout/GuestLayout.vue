    ...
    <header class="sticky top-0 z-50 border-b border-emerald-500/15 bg-[#071a13]/85 backdrop-blur-md">
      <div class="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
        <router-link to="/" class="flex items-center gap-3 group">
          ...
          <span class="text-lg font-medium tracking-tight text-white">ATI <span
              class="text-emerald-400/60 font-light"></span></span>
        </router-link>
      ...
      <div class="mx-auto max-w-7xl">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div class="space-y-4">
            ...
            <p class="text-[13px] text-emerald-200/60 font-light leading-relaxed">
          ...
          <div>
            ...
            <ul class="space-y-3 text-[13px] text-emerald-200/60 font-light">
              <li><router-link to="/contact-us" class="hover:text-emerald-300 transition-colors">Help
          ...
          <div>
            <h4 class="text-[10px] font-medium uppercase tracking-[0.2em] text-emerald-400 mb-4">Get The App</h4>
            <div class="flex flex-col gap-2.5">
              <a href="https://play.google.com/store/apps/details?id=com.msegs.training_apps" target="_blank"
                rel="noopener noreferrer"
                class="flex items-center gap-3 px-3.5 py-2.5 bg-[#0a2319] hover:bg-[#103828] border border-emerald-500/20 hover:border-emerald-400/40 rounded-xl transition-all group">
                ...
                <div class="text-left">
                  <p class="text-[9px] text-emerald-300/70 uppercase leading-none font-medium">Get it on</p>
                  <p class="text-xs font-bold text-white leading-tight">Google Play</p>
                </div>
              </a>

              <a href="https://apps.apple.com/in/app/atimiz/id6788260969" target="_blank" rel="noopener noreferrer"
                class="flex items-center gap-3 px-3.5 py-2.5 bg-[#0a2319] hover:bg-[#103828] border border-emerald-500/20 hover:border-emerald-400/40 rounded-xl transition-all group">
                <svg class="w-5 h-5 text-zinc-100 shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  <path
                ...
                <div class="text-left">
                  <p class="text-[9px] text-emerald-300/70 uppercase leading-none font-medium">Download on the</p>
                  <p class="text-xs font-bold text-white leading-tight">App Store</p>
                </div>
              </a>
            </div>
          </div>
