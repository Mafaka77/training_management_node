    ...
    <div
      ...
      <table class="w-full text-left">
        ...
        <tbody class="divide-y divide-zinc-100 dark:divide-white/5">
          <tr v-for="trainee in attendanceData" :key="trainee._id"
            class="group hover:bg-zinc-50/50 dark:hover:bg-white/[0.01] transition-colors">

            <td class="px-6 py-4">
              <div class="flex items-center gap-3">
                <div
                  class="w-10 h-10 rounded-xl bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center border border-zinc-200 dark:border-white/10">
