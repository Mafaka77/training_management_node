<template>
  <div class="max-w-[90rem] mx-auto pb-10">
    ...
    <div class="flex border-b border-zinc-200 dark:border-white/10 mb-8">
          ...
          <table class="w-full text-left border-collapse">
            <thead>
              <tr class="bg-zinc-50 dark:bg-white/[0.02] border-b border-zinc-200 dark:border-white/10">
                ...
                <th class="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-500">Training Program
                </th>
    ...
    <div v-show="activeTab === 'orders'">
      <div
        ...
        <div v-if="!enrolledOrders || enrolledOrders.length === 0"
          class="px-6 py-5 border-b border-zinc-200 dark:border-white/10 flex justify-between items-center">
          <h3 class="text-base font-bold text-zinc-900 dark:text-zinc-100">Generated Orders</h3>
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-left border-collapse">
            <thead>
              <tr class="bg-zinc-50 dark:bg-white/[0.02] border-b border-zinc-200 dark:border-white/10">
                <th class="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-500">Document Name</th>
                <th class="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-500">Generated On</th>
                <th class="px-6 py-4 text-[10px] font-black uppercase tracking-widest text-zinc-500 text-right">Actions
                </th>
              </tr>
            </thead>
            <tbody class="divide-y divide-zinc-100 dark:divide-white/5">
              <tr v-if="!enrolledOrders || enrolledOrders.length === 0">
                <td colspan="3" class="px-6 py-20 text-center">
                  <div class="flex flex-col items-center justify-center">
                    ...
                    <p class="text-sm text-zinc-500 font-medium">No orders generated yet.</p>
                  </div>
                </td>
              </tr>
              ...
              <tr v-else v-for="order in enrolledOrders" :key="order._id"
                ...
                <td class="px-6 py-4">
                  <div class="flex items-center gap-3">
                    <div
                      class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 flex items-center justify-center text-blue-600 dark:text-blue-400 border border-blue-100 dark:border-blue-900/50">
