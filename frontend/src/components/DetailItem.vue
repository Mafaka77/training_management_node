  ...
  <div class="group flex items-start gap-3 p-3 rounded-xl transition-all duration-300 hover:bg-zinc-100 dark:hover:bg-white/[0.04]">
    <div class="mt-0.5 h-8 w-8 rounded-lg bg-zinc-100 dark:bg-white/5 flex items-center justify-center text-zinc-400 group-hover:text-blue-500 group-hover:scale-110 transition-all duration-300 flex-shrink-0">
      <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <path v-else-if="icon === 'Identification'" stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
        <path v-else-if="icon === 'Phone'" stroke-linecap="round" stroke-linejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
    ...
    <div class="flex flex-col">
      <span class="text-[10px] font-black uppercase tracking-[0.15em] text-zinc-400 group-hover:text-zinc-500 transition-colors">
        {{ label }}
      </span>
      <span class="text-sm font-bold text-zinc-800 dark:text-zinc-200 break-all leading-tight mt-0.5">
        {{ value || '---' }}
      </span>
    </div>
  </div>
