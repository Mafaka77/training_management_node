<template>
      ...
      <div class="flex items-center gap-2 sm:gap-4">
        ...
        <div class="relative flex items-center gap-3 pl-3 border-l border-zinc-200 dark:border-white/10">
          ...
          <button @click="userMenuOpen = !userMenuOpen"
            ...
            <div
              class="w-full h-full bg-gradient-to-tr from-blue-600 to-indigo-400 flex items-center justify-center text-white font-bold text-xs">
          ...
          <transition name="pop">
            <div v-if="userMenuOpen"
              ...
              <div class="p-2">
                <button
                  class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs font-semibold transition-colors hover:bg-zinc-100 dark:hover:bg-white/5">
  ...
  <Dialog :show="isLogoutDialog" :loading="isLoading" title="Logout" message="Are you sure?" confirm-text="Logout"
