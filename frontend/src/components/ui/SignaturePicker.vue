<template>
    <div class="w-full">
        ...
        <div class="relative flex flex-col items-center justify-center w-full min-h-[150px] border-2 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
            :class="error ? 'border-red-500' : 'border-gray-300'" @click="$refs.fileInput.click()">
            <input type="file" ref="fileInput" class="hidden" accept=".png, .jpg, .jpeg, image/png, image/jpeg"
                @change="handleFileChange" />

            <div v-if="previewUrl" class="relative w-full h-full p-2">
                <img :src="previewUrl" class="max-h-48 w-full object-contain rounded-lg" alt="Preview" />
            ...
            <div v-else class="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <p class="mb-2 text-sm text-gray-500 dark:text-gray-400 font-semibold">Click to upload signature</p>
